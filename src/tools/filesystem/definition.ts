 ...
 */
export const registerFilesystemTools = (
  config: AppConfig
): ToolDefinition[] => {
  ...
  return [
    ...
    },
    {
      name: "read_file",
      description:
        "Read content from a file. File must be within allowed directories.",
    ...
    },
    {
      ...
      description:
        "Read content from multiple files. Files must be within allowed directories.",
    ...
    },
    {
      name: "write_file",
      description:
        "Write content to a file. File must be within allowed directories.",
    ...
    },
    {
      name: "list_directory",
      description:
        "List contents of a directory. Directory must be within allowed directories.",
